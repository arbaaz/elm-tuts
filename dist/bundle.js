		...
		A2(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Json_Decode$string)))));
var _user$project$Main$postsDecoder = _elm_lang$core$Json_Decode$list(
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
...
var _user$project$Main$X = F2(
	function (a, b) {
		return {after: a, children: b};
	});
var _user$project$Main$dataDecoder = A2(
	...
	A3(
		...
		A2(_elm_lang$core$Json_Decode$field, 'after', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'children', _user$project$Main$postsDecoder)));
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {data: a, query: b, error: c, after: d};
	});
...
var _user$project$Main$fetchPosts = function (model) {
	...
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Main$dataDecoder);
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Posts':
				if (_p0._0.ctor === 'Ok') {
					var _p1 = _p0._0._0;
					var log = A2(_elm_lang$core$Debug$log, 'value of x', _p1);
					return {
						ctor: '_Tuple2',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"RecordQuery":["String"],"FetchPosts":[],"Posts":["Result.Result Http.Error Main.X"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Main.PostList":{"args":[],"type":"List Main.Post"},"Main.Post":{"args":[],"type":"{ url : String , title : String , ups : Int , source : Maybe.Maybe String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.X":{"args":[],"type":"{ after : String, children : Main.PostList }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
